...
DOTLY_REPOSITORY=${DOTLY_REPOSITORY:-TeoDev1611/dotfiles}
...
_w "  ┌────────────────────────────────────┐"
_w "~ │ 🚀 Welcome to the ${green}teodev dotfiles${normal} installer! │ ~"
_w "  └────────────────────────────────────┘"
_w
...
_a "🎉 Teo Dotfiles installed correctly! 🎉"
_a "Please, restart your terminal to see the changes"
_a "MAKE WITH DOTLY INSTALLER"
